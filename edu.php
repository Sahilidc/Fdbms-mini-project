...
// Check if the "Education" button is clicked
if (isset($_POST['education'])) {
    // Query to fetch petitions with category 'Education'
    $sql = "SELECT * FROM petition1 WHERE Cat = 'Education'";
...
<head>
    ...
    <title>Purple Petitions - Education</title>
    <link rel="stylesheet" href="purple.css">
</head>
<body>
    <div class="container">
        <h2>Purple Petitions - Education</h2>
        <form method="post">
