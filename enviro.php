...
// Check if the "Environment" button is clicked
if (isset($_POST['environment'])) {
    // Query to fetch petitions with category 'Environment'
    $sql = "SELECT * FROM petition1 WHERE Cat = 'Environment'";
...
<head>
    ...
    <title>Purple Petitions - Environment</title>
    <link rel="stylesheet" href="purple.css">
</head>
<body>
    <div class="container">
        <h2>Purple Petitions - Environment</h2>
        <form method="post">
            <input type="submit" name="environment" value="Environment">
        </form>
        <?php
