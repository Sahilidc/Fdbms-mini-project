...
// Check if the "Disability" button is clicked
if (isset($_POST['disability'])) {
    // Query to fetch petitions with category 'Disability'
    $sql = "SELECT * FROM petition1 WHERE Cat = 'Disability'";
...
<head>
    ...
    <title>Purple Petitions - Disability</title>
    <link rel="stylesheet" href="purple.css">
</head>
<body>
    <div class="container">
        <h2>Purple Petitions - Disability</h2>
        <form method="post">
            <input type="submit" name="disability" value="Disability">
        </form>
        <?php
